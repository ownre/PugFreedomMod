...
public class Command_pfm extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        playerMsg("The PugFreedomMod was made by rovertdude, xXStellaXx, and Duckeroo.", ChatColor.GOLD);
        ...
        playerMsg("TotalFreedomMod was created by Madgeek1450 and Prozza.", ChatColor.GOLD);
        playerMsg("Visit " + ChatColor.AQUA + "pugfreedommod.boards.net" + ChatColor.GREEN + " for more information.", ChatColor.GREEN);
